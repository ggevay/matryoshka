...
/**
 * GG: I copied this over from Apache Commons and changed FastMath.pow to just Math.pow.
 * For some reason, the FastMath.pow calls were 1000X slower on the cluster :O I have no idea why...
 *
 ...
 */
public class ZipfDistributionGG extends AbstractIntegerDistribution {
     ...
     * or {@code exponent <= 0}.
     */
    public ZipfDistributionGG(final int numberOfElements, final double exponent) {
     ...
     * @since 3.1
     */
    public ZipfDistributionGG(RandomGenerator rng,
